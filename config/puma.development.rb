# Ansible managed: /home/smw/Workspaces/koreci-s/railsbox/ansible/roles/puma/templates/puma.rb.j2 modified on 2018-01-24 10:59:52 by smw on flynn
...
bind "unix:///tmp/koreci-s/sockets/puma.development.sock"
...
pidfile "/tmp/koreci-s/pids/puma.development.pid"
...
stdout_redirect "/koreci-s/log/puma.development.log", "/koreci-s/log/puma.development.err.log"
